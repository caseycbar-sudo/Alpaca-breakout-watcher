...
function render(data){
  ...
  $('connection-alpaca').textContent=`${system.watcher||'unknown'} · ${system.market_data||'market data'}`;$('connection-email').textContent=system.email_bridge||'standing by';$('connection-paper').textContent=`${paper.completed_trades||0} completed · ${paper.open_trades||0} open`;
